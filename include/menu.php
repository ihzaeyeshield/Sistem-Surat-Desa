...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        ...
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                ...
                <div class="logo-side center blue-grey darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                echo '<h5 class="Baldes">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="Baldes">Kecamatan Sukodadi</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Sukodadi - Lamongan</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li><a href="?page=ref"><i class="material-icons middle">class</i> eferensi</a></li>
            <li class="no-padding">
            <?php
                if($_SESSION['admin'] == 1){ ?>
                <ul class="collapsible collapsible-accordion">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./"><i>Kec Sukodadi</i></a></li>
            <li><div class="grs"></></li>
