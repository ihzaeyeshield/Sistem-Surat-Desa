            ...
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jl. RA Kartini No. 01 Sawo - Dukun - Gresik</span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td id="right"><strong>Nama Pengirim</strong></td>
                            ...
                            <tr class="isi">
                                ...
                                echo '
                                <tr class="isi">
                                    <td colspan="2"><strong>Nama Pengirim:</strong>
                                    </td>
